...
;note that your search term in the inputbox also gets capture if the inputbox is in the designated area for OCR.
;note the inputbox may also block matching terms if it is sitting in front of them
;if the script is missing obvious matches, try using the UWP API OCR Mouse Click Drag to OCR script to see if the OCR result comes out accurately
...
ocr(file, lang := "FirstFromAvailableLanguages", mytext :="")
{

export class Sheep {
    ...
    getY2(x, dot) {
        const total = 200;
        let pt = this.getPointOnQuard(dot.x1, dot.y1, dot.x2, dot.y2, dot.x3, dot.y3, 0);
        let prevX = pt.x;
        for (let i = 1; i<total; i++) {
            const t = i/total;
            pt = this.getPointOnQuard(dot.x1, dot.y1, dot.x2, dot.y2, dot.x3, dot.y3, t);
